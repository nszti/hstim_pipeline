        ...
        for repeat in range(num_repeats):
            for stim_idx in range(num_stims_per_repeat):
                if stim_idx == 0 and repeat == 0:
                    ...
                    start_stim = int(stim_start_times[0]) + stim_idx * frame_rate * start_btw_stim
                else:
                    start_stim = int(stim_start_times[0]) + (stim_idx - 1) * start_btw_stim * frame_rate + repeat * trial_delay
